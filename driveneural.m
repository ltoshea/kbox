function [net] = driveneural(X,labels)

% Solve a Pattern Recognition Problem with a Neural Network
% Script generated by NPRTOOL
% Created Thu May 08 16:10:47 BST 2014
%
...
x = X';
t = labels';
%t = fliplr(t); % Added this to get classes right;
...
if (false)
  ...
  genFunction(net,'neuralnet','MatrixOnly','yes');
  y = neuralnet(x);
end
if (false)
